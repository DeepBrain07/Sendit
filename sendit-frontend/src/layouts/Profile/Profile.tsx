...
const Profile = () => {
    ...
    const options1 = {"Verification Center":"material-symbols-light:domain-verification-rounded",
            ...
            <div className="background !justify-start !flex !flex-col">
                ...
                <div className="gradient-layer-alt2 flex flex-col p-4 pr-8 pt-8 gap-8 !text-white !h-fit">
                    ...
                    <div className="flex items-center flex-col gap-2">
                        <div className="rounded-xl border-2 border-primary w-fit h-fit">
                            <img src={profileImage} alt="Profile" className="size-16 rounded-xl"/>
                        </div>
                        <div className="flex items-center gap-1">
                            <h2 className="!font-bold !text-xl">Alao Heritage</h2>
                ...
                <div className="mt-[320px] p-4 w-full pr-8">
                    ...
                    <div className=" bg-gray-100 rounded-xl border-1 border-gray-200  flex flex-col  items-start w-full ">
                        {Object.entries(options1).map(([option, icon]) => (
                            <div key={option} className={`cursor-pointer hover:bg-gray-200 ${Object.keys(options1).indexOf(option) > 0 && 'border-t-1 border-gray-200'} flex items-center gap-4 p-4 rounded-lg transition-colors w-full`}>
                    ...
                    <div className=" mt-6 bg-gray-100 rounded-xl border-1 border-gray-200  flex flex-col  items-start w-full ">
                        {Object.entries(options2).map(([option, icon]) => (
                            <div key={option} className={`cursor-pointer hover:bg-gray-200 ${Object.keys(options2).indexOf(option) > 0 && 'border-t-1 border-gray-200'} flex items-center gap-4 p-4 rounded-lg transition-colors w-full`}>
                                <div className="flex gap-2 justify-center items-center">
                                    <div className="p-2 bg-white rounded-[50%] ">
